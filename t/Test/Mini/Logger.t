...
sub test_timings {
    ...
    assert_in_delta($logger->time('TestCaseOne#test_one'), 0.1, 0.01);
    assert_in_delta($logger->time('TestCaseOne#test_two'), 0.2, 0.01);
    assert_in_delta($logger->time('TestCaseOne'),          0.3, 0.01);
    assert_in_delta($logger->time('TestCaseTwo#test_one'), 0.4, 0.01);
    assert_in_delta($logger->time('TestCaseTwo'),          0.4, 0.01);
    assert_in_delta($logger->time($logger),                0.7, 0.01);
}
